...
public class Chatserver implements IChatserverCli, Runnable {
	...
	private ConcurrentHashMap<String,Socket> loggedInUsers = new ConcurrentHashMap<String,Socket>();
	private ConcurrentHashMap<String,String> privateMessageUsers = new ConcurrentHashMap<String,String>();
